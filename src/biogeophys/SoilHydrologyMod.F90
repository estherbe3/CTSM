...
#include "shr_assert.h"
  ...
  use clm_varctl        , only : iulog, use_vichydro, use_excess_ice_tiles, use_tiles_lateral_water
...
!#4
   ...
   subroutine PerchedLateralFlow(bounds, num_hydrologyc, filter_hydrologyc, &
     ...
     real(r8) :: A_src, A_drc                            ! Area of the source tile, Area of the recieving tile
     real(r8) :: dtime                                   ! land model time step (sec)
     real(r8) :: wtsub                                   ! summation of hk*dzmm for layers below water table (mm**2/s)
     real(r8) :: h2osoi_vol
